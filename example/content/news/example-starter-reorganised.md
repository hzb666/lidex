...
description: The bundled example was rewritten as a Lidex explanation site while keeping the same engine behavior.
...
The example site is meant to answer a practical question: if someone installs Lidex, what files do they create first and how do those files relate. That is why the current example keeps concepts, setup, blocks, details, queries, and theme as separate readable pages.
...
If you are adapting Lidex for your own project, use this example as a structural reference first and a visual reference second. The important parts are the file layout, the route mapping, the block declarations, and the override boundaries.